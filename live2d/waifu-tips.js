...
function loadWidget(config) {
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			if (location.hostname === referrer.hostname) text = `欢迎访问<span>「${document.title.split(" - ")[0]}」【 官方网址：http://akday.club/ 】</span>`;
			...
			text = `欢迎访问<span>「${document.title.split(" - ")[0]}」【 官方网址：http://akday.club/ 】</span>`;
		}
